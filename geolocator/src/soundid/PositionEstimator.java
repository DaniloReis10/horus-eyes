...
/**
 * Classe responsavel por baseado nas medidas de tempo das bases fazer uma
 * estimativa da localizacao da TAG
 * 
 * @author DaniloReis
 * 
 */
public class PositionEstimator {
    ...
    public PositionEstimator(TimeMeasurePoint measures) {
        ...
        area = new LocationArea(SoundIdModel.getLatitudeIni(), SoundIdModel.getLongitudeIni(),
                SoundIdModel.getLatitudeEnd(), SoundIdModel.getLongitudeEnd(), SoundIdModel.getWidth(),
